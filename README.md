...
Named after kRusty the Clown. Vaguely inspired by pydantic's [monty](https://github.com/pydantic/monty), which interprets a Python subset using Rust. theclown goes the other way: it interprets Rust in Python 🤡.
